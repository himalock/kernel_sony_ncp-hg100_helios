...
**
**  Abstract:
**      This code is to download the firmware to CX2092X device via I2C bus.
**
**
**  Product Name:
**      Conexant Hudson
...
int cx_download_fw(        void *                      pBuffer,
                       const unsigned char*        pBootLoader,
                       u32               cbBootLoader,
                       const unsigned char*        pImageData,
                       u32               cbImageData,
                       unsigned char               slave_address,
                       SFS_UPDATE_PARTITION        DownLoadMode );
 ...
 *
 */
void cx_mdelay(unsigned int ms_delay);
...
#define ERRON_UPDATE_EEPROM_FAILED  112
#define ERRON_INVALID_BOOTLOADER    113
